      ...
      <div className="signlang_detection-container">
        ...
        (
          <div className="signlang_detection_notLoggedIn">
             ...
             <p>
              Chúng tôi lưu dữ liệu phát hiện của bạn để hiển thị tiến độ và học tập của bạn trong bảng điều khiển, vì vậy vui lòng đăng nhập để thử tính năng phát hiện này.
             </p>
          </div>
        )}
      </div>
