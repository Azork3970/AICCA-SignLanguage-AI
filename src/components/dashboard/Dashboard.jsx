        ...
        signDataList.length > 0 ? (
          <>
            <div className="signlang_header-data">
              ...
              <div className="signlang_leader-board">
                <h2 className="gradient__text title">Người Dùng Hàng Đầu Của Chúng Tôi</h2>
          ...
          <div className="signlang__nodata-cont">
            ...
            <h3 className="gradient__text">
              Không Có Dữ Liệu Để Hiển Thị, Vui Lòng Quay Lại Phát Hiện Để Đánh Dấu Việc Học Của Bạn
            </h3>
          </div>
        )
      ) : (
